...
async function CreateMediaTypeRequest(req, res, next) {
    const data = req.body;
    ...
    const existing = await models.MediaType.findOne({ where: { name: value.name } });
...
module.exports = CreateMediaTypeRequest;
