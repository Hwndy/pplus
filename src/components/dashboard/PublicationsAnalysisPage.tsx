    ...
    <div className="space-y-8 animate-fade-in relative">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2 tracking-tight">Publications, Reporters & Spokespersons Analysis</h1>
            <p className="text-blue-100 text-lg">Media coverage insights, reporter engagement, and spokesperson visibility</p>
            {activePair && (
              ...
              <CardContent>
                <div className="h-80">
                  {spokespersons.length > 0 ? (
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={spokespersons} layout="vertical" margin={{ top: 5, right: 30, left: 5, bottom: 5 }}>
                        <XAxis type="number" axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#6B7280' }} />
                        <YAxis dataKey="name" type="category" width={200} axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: '#374151' }} />
                        <Tooltip content={<CustomTooltip />} />
                        <Bar dataKey="percentage" fill="url(#indigoGradient)" radius={[0, 4, 4, 0]} />
                        <defs>
                    ...
                    <div className="h-full flex items-center justify-center text-gray-400">
                      <p>{hasValidDateRange ? 'No spokespersons found' : 'Select date range to view data'}</p>
                    </div>
                  )}
                </div>
              </CardContent>
              ...
              {analysisData ? (
                <>
                  ...
                  {top3Spokespersons.length > 0 && (
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-100 rounded-lg p-5 shadow-sm border border-indigo-200">
                      <div className="flex items-center gap-2 mb-4">
                        <Trophy className="w-5 h-5 text-indigo-700" />
                        <p className="font-semibold text-gray-800">Top 3 Spokespersons</p>
                      </div>
                      <div className="space-y-3">
                        {top3Spokespersons.map((spokesperson) => (
                          <div key={spokesperson.rank} className="flex items-center justify-between py-2">
                            <div className="flex items-center gap-3 flex-1">
                              <span className="text-lg font-bold text-indigo-700 w-6">#{spokesperson.rank}</span>
                              <div>
                                <p className="text-sm font-medium text-gray-800 truncate max-w-[180px]">{spokesperson.name}</p>
                              </div>
                            </div>
                            <div className="text-right">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <p className="text-sm text-gray-500 mb-1">Unique Spokespersons</p>
                    <p className="text-2xl font-bold text-gray-900">
