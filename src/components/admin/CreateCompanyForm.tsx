...
export default function CreateCompanyForm({
  ...
  useEffect(() => {
    const fetchCompanies = async () => {
      ...
      try {
        const res = await axios.get('https://pplus-oez4.onrender.com/api/v1/companies/?limit=1000');
  ...
  useEffect(() => {
    const fetchOptions = async (category: string, setter: (opts: string[]) => void, loadingSetter: (v: boolean) => void) => {
      loadingSetter(true);
      try {
        const res = await axios.get(`https://pplus-oez4.onrender.com/api/v1/data-parameters/category/${category}`);
    ...
    try {
      ...
      for (const form of companyForms) {
        ...
        const res = initialValues && form.id
          ? await axios.put(`https://pplus-oez4.onrender.com/api/v1/companies/update/${form.id}`, payload)
          : await axios.post('https://pplus-oez4.onrender.com/api/v1/companies/create', payload);
