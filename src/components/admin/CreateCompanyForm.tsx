...
export default function CreateCompanyForm({
  ...
  useEffect(() => {
    const fetchCompanies = async () => {
      ...
      try {
        const res = await axios.get('https://p-fw0o.onrender.com/api/v1/companies/?limit=1000');
  ...
  useEffect(() => {
    const fetchOptions = async (category: string, setter: (opts: string[]) => void, loadingSetter: (v: boolean) => void) => {
      loadingSetter(true);
      try {
        const res = await axios.get(`https://p-fw0o.onrender.com/api/v1/data-parameters/category/${category}`);
    ...
    try {
      ...
      for (const formData of companyForms) {
        ...
        const endpoint = formData.id && initialValues
          ? `https://p-fw0o.onrender.com/api/v1/companies/update/${formData.id}`
          : 'https://p-fw0o.onrender.com/api/v1/companies/create';
