...
const PublicationsPage: React.FC = () => {
  ...
  const fetchPublications = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://pplus-gl9c.onrender.com/api/v1/data-parameters/category/Publications`,
        { headers }
      );
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      setDeletingId(id);
      const response = await fetch(`https://pplus-gl9c.onrender.com/api/v1/data-parameters-category-value/delete/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const updatePublication = async (id: number, value: string) => {
    const response = await fetch(
      `https://pplus-gl9c.onrender.com/api/v1/data-parameters-category-value/update/${id}`,
      {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
  ...
  const createPublication = async (value: string) => {
    ...
    const paramResponse = await fetch('https://pplus-gl9c.onrender.com/api/v1/data-parameters', {
      headers: {
        Authorization: `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
    ...
    const createResponse = await fetch(
      'https://pplus-gl9c.onrender.com/api/v1/data-parameters-categoryvalue/create',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
