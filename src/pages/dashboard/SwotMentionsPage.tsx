...
export function SwotMentionsPage() {
  ...
  const fetchSwotData = useCallback(async (page: number = 1, limit: number = 10) => {
    ...
    try {
      let endpoint = 'https://p-fw0o.onrender.com/api/v1/swot-analysis';

      if (isSupervisor) {
        endpoint = 'https://p-fw0o.onrender.com/api/v1/swot-analysis/supervisor-mentions';
      } else if (isAnalyst) {
        endpoint = 'https://p-fw0o.onrender.com/api/v1/swot-analysis/my-analysis';
      }
  ...
  const handleDelete = async (swot: SwotAnalysis) => {
    ...
    try {
      const response = await fetch(`https://p-fw0o.onrender.com/api/v1/swot-analysis/delete/${swot.id}`, {
        method: 'PUT',
